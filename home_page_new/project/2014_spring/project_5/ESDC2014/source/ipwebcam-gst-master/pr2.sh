...
#         sudo apt-get install python-apport v4l2loopback-dkms 2
...
#     if can_run apt-get; then
#         sudo apt-get install v4l-utils 3
...
#     sudo apt-get install pavucontrol 4
# fi
...
#         sudo apt-get install gstreamer-tools 5
#     fi
# elif can_run pacman; then
#     # Arch
#     GSTLAUNCH=gst-launch-0.10
